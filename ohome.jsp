<%-- 
    Document   : ohome
    Created on : Jun 24, 2017, 3:15:13 PM
    Author     : java3
--%>
                ...
                <div class="item" style="background-image: url(images/slider/slider5.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Data Dynamic Possession Checking in Cloud Storageorage</h1>
        ...
        <div class="container">
            ...
            <ul class="portfolio-filter text-center">
             ...
             <div class="center wow fadeInDown">
                <h2>Data Owner Home</h2>
                
            </div>
            <center> <img class="img-responsive" src="images/services/owner.png"></center>
