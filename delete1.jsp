<%-- 
    Document   : delete1
    Created on : Jul 4, 2017, 12:50:20 PM
    Author     : java3
--%>
...
String omail=(String)session.getAttribute("omail");
    ...
    try {
        ...
        int i = st.executeUpdate("insert into ort (oid, omail, fid, str1, str2, str3, status, dynamic, time)values('" + oid + "','" + omail + "','" + fid + "','" + block1 + "','" + block2 + "','" + block3 + "','waiting','delete','"+time+"')");
        if (i != 0) {

            System.out.println("Deleting Request ort table successfull");
