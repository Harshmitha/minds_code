<%-- 
    Document   : modify
    Created on : Jul 4, 2017, 12:42:56 PM
    Author     : java3
--%>
                    ...
                    <div class="item" style="background-image: url(images/slider/slider5.jpg)">
                        <div class="container">
                            <div class="row slide-margin">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                        <h1 class="animation animated-item-1">Data Dynamic Possession Checking in Cloud Storageloud Storage</h1>
        ...
        <section id="recent-works">
            <div class="container">
                ...
                <div class="center wow fadeInDown">
                    <h2>Modify Data in the Block</h2>
                ...
                <div class="row">
                    <div class="features">
                        <div id="contact-page clearfix">
                            ...
                            <img style="float: right;width: 500px;height: 500px" class="img-responsive" src="images/services/jj.jpg">
                            <form  role="form" id="main-contact-form" class="contact-form" name="contact-form" enctype="multipart/form-data" method="get" action="modify1.jsp">
                                <div class="row">
                                    <div class="col-sm-5">
