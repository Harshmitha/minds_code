<%-- 
    Document   : dynamic
    Created on : Jul 3, 2017, 6:28:49 PM
    Author     : java3
--%>
...
<html lang="en">
    <%
        ...
        %>
        <script>alert('Data Updating Request Send Successfully ');</script>
        <%            }
        %>
                    ...
                    <div class="item" style="background-image: url(images/slider/slider5.jpg)">
                        <div class="container">
                            <div class="row slide-margin">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                        <h1 class="animation animated-item-1">Data Dynamic Possession Checking in Cloud Storageocol in Cloud Storage</h1>
        ...
        <section   id="recent-works">
            <div class="container">
                ...
                <div class="center wow fadeInDown">
                    <h2>Dynamic Operations On Data's</h2>                
                </div>

                <center><table style="width: 800px" summary="Summary Here" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th style="color:  #c52d2f">Insert</th>
                                <th style="color:  #c52d2f">Modify</th>
                                <th style="color:  #c52d2f">Delete</th>
                            </tr>
                        </thead>
                        <%
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="insert.jsp?fid=<%=rs.getString("id")%>">Insert</a></td>           
                                <td><a href="modify.jsp?fid=<%=rs.getString("id")%>">Modify</a></td>
                                <td><a href="delete.jsp?fid=<%=rs.getString("id")%>">Delete</a></td>
                            </tr>
