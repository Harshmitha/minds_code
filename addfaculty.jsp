  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="addfaculty.jsp">Add Faculty</a></li>
    
          <!-- <li><a href="viewreports1.jsp">Faculty View Report</a></li> -->
 ...
 <div class="container-fluid text-center">
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h2 align="center">Faculty Registration </h2> <br>
  <form class="form-horizontal" action="adduser.jsp">
