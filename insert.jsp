<%-- 
    Document   : insert
    Created on : Jul 3, 2017, 6:41:08 PM
    Author     : java3
--%>
                    ...
                    <div class="item" style="background-image: url(images/slider/slider5.jpg)">
                        <div class="container">
                            <div class="row slide-margin">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                        <h1 class="animation animated-item-1">Data Dynamic Possession Checking in Cloud Storage Remote Data Possession Checking Protocol in Cloud Storage</h1>
        ...
        <section id="recent-works">
            <div class="container">
                ...
                <ul class="portfolio-filter text-center">
                    ...
                    <li><br><br><a class="btn btn-default active" href="dynamic.jsp">Dynamic Operations</a></li>
                    <li><a class="btn btn-default active" href="downloadfile.jsp">Download Files</a></li>
                    <li><a class="btn btn-default active" href="olog.jsp" >Logout</a></li>
                </ul><br><br>
                <div class="center wow fadeInDown">
                    <h2>Insert Data in the Block</h2>
                ...
                <div class="row">
                    <div class="features">
                        <div id="contact-page clearfix">
                            ...
                            <img style="float: right;width: 500px;height: 500px" class="img-responsive" src="images/services/fgn.jpg">
                            <form  role="form" id="main-contact-form" class="contact-form" name="contact-form" enctype="multipart/form-data" method="get" action="insert1.jsp">
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <div style="float: left" class="form-group">
                                            <button type="submit" style="width: 200px" class="btn btn-primary btn-lg" required="required">Insert</button>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
