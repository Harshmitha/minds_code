<%-- 
    Document   : cloudlog
    Created on : Jun 28, 2017, 11:08:36 AM
    Author     : java3
--%>
    ...
    <section id="recent-works">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2 style="color:  #c52d2f">Cloud Login</h2>                
            </div>

            <div class="row">
                 <!-- <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="clog1.jsp" role="form"> -->
                     <form method="post" action="clog1.jsp" >
                     <img style="float: right;margin-right: 50px" class="img-responsive" src="images/services/clog.jpg">           
                     <div class="row">
                                    <div class="col-sm-5">
