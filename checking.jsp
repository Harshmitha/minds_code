<%-- 
    Document   : checking
    Created on : Jul 1, 2017, 10:28:24 AM
    Author     : java3
--%>
...
<html lang="en">
    <%
        ...
        %>
        <script>alert('Data Possession Challenge Sending Failed');</script>
        <%            }
        %>
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="item" style="background-image: url(images/slider/slider5.jpg)">
                        <div class="container">
                            <div class="row slide-margin">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                        <h1 class="animation animated-item-1">A Novel Efficient Remote Data Possession Checking Protocol in Cloud Storage</h1>
        ...
        <section   id="recent-works">
            <div class="container">
                ...
                <div class="center wow fadeInDown">
                    <h2>Data Possession Challenge </h2>                
                </div>
                <center><table style="width: 1000px" summary="Summary Here" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th style="color:  #c52d2f">Status</th>
                                <th style="color:  #c52d2f">Data Possession Challenge</th>
                            </tr>
                        </thead>
                        <%
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=rs.getString("status")%></td>
                                 <td><a href="checking1.jsp?id=<%=rs.getString("id")%>">Challenge</a></td>
                            </tr>
                        </tbody>
                        <%}
                            } catch (Exception e) {
