...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#"> Search Faculty Subject </a></li>
 ...
 <div class="container-fluid text-center">
  ...
  <div class="row content">
	...
	<center><h2>Faculty Table</h2></center>
...
<table id="example" class="display" style="width:100%">
        ...
        try {
			...
			ResultSet rs;
			String sql = "select * from subject_mapping where dept='"+dept+"' and branch='"+branch+"'";
...
<table id="example" class="display" style="width:100%">
      <thead>
        ...
        try {
			...
			Statement st = con.createStatement();
			ResultSet rs;
			String sql = "select * from subject_mapping where dept='"+dept+"' and course='"+course+"'";
			rs = st.executeQuery(sql);
			while (rs.next()) {
        %>
            <tr>
