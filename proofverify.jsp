<%-- 
    Document   : proofverify
    Created on : Jul 1, 2017, 6:19:43 PM
    Author     : java3
--%>
...
<html lang="en">
    <%
        ...
        %>
        <script>alert('Data Possession Challenge Sent Successfully');</script>
        <%            }
        %>
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="item" style="background-image: url(images/slider/slider4.jpg)">
                        <div class="container">
                            <div class="row slide-margin">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                        <h1 class="animation animated-item-1">A  Efficient Remote Data Possession Checking Protocol in Cloud Storage</h1>
        ...
        <section   id="recent-works">
            <div class="container">
                ...
                <div class="center wow fadeInDown">
                 ...
                 <img style="float: right;width: 400px;height: 500px" class="img-responsive" src="images/services/inte.jpg">
                <table style="width: 500px;float: left" summary="Summary Here" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                <th style="color:  #c52d2f">File Id</th>
                                <th style="color:  #c52d2f">Name</th>                                                                         
                                <th style="color:  #c52d2f">Date & Time</th>                                                         
                                <th style="color:  #c52d2f">Proof Verify</th>
                            </tr>
                        </thead>
                        <%
                            ...
                            ResultSet rs = null;
                            try {                             
                                rs = st.executeQuery("select * from file_upload where oid='" + oid + "'and status='challenged'");
                                while (rs.next()) {
                                    session.setAttribute("filesid",rs.getString("id") );
                                    session.setAttribute("hashs1",rs.getString("hash1") );
                                    session.setAttribute("hashs2",rs.getString("hash2") );
                                    session.setAttribute("hashs3",rs.getString("hash3") );
                        %>
                        <tbody>
                            <tr>
                                ...
                                <td><%=rs.getString("dtime")%></td>                               
                                 <td><a href="proofverify1.jsp?id=<%=rs.getString("id")%>">Verify</a></td>
                            </tr>
                        </tbody>
                        <%}
                            } catch (Exception e) {
