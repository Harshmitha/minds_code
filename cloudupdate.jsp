<%-- 
    Document   : cloudupdate
    Created on : Jul 4, 2017, 1:58:46 PM
    Author     : java3
--%>
        ...
        <section id="recent-works">
            <div class="container">
                ...
                <div class="center wow fadeInDown">
                    <h2 style="color: #c52d2f">Data Update Request's </h2>                
                </div>
               ...
               <center> <table style="width: 800px;" summary="Summary Here" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th style="color:  #c52d2f">Owner Id</th>
                                <th style="color:  #c52d2f">Owner Mail</th>
                                <th style="color:  #c52d2f">File Id</th>
                                <th style="color:  #c52d2f">Dynamic Operation</th>
                                <th style="color:  #c52d2f">Date & Time</th>
                                <th style="color:  #c52d2f">Update</th>
                        ...
                        <%
                            ...
                            ResultSet rs = null;
                            try {
                                rs = st.executeQuery("select * from ort where status='waiting'");
                                while (rs.next()) {
                                   session.setAttribute("time",rs.getString("time") );
                                   session.setAttribute("fidd",rs.getString("fid") );
                                   session.setAttribute("omail",rs.getString("omail") );
                        %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=rs.getString("dynamic")%></td>
                                 <td><%=rs.getString("time")%></td>
                                
                                <td><a href="cloudupdate1.jsp?id=<%=rs.getString("id")%>">Update</a></td>           
